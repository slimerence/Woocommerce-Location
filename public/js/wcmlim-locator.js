jQuery(document).ready(function (t) {
    ...
    t("#wcmlim-change-sl-select, #wcmlim-change-sl-select option").on("change", function () {
            ...
            t.ajax({
                ...
                success(e) {
                    ...
                    l &&
                        ...
                        t(".wcmlim-lc-select").prepend('<option value="-1" selected="selected" >Please Select</option>'),
                        t("#wcmlim-change-lcselect").prepend('<option value="-1" selected="selected">Please Select</option>'),
